...
import type { ElementType } from "./common.js";
type EventHandlers<E> = {
    [K in keyof E]?: E[K] extends (...args: any) => any ? E[K] : (payload: E[K]) => void;
};
type EventKeys = keyof EventHandlers<DOMAttributes<HTMLElement>>;
interface SVGAttributesWithoutMotionProps extends Pick<SVGAttributes<SVGElement>, Exclude<keyof SVGAttributes<SVGElement>, keyof Options | keyof AriaAttributes | EventKeys>> {
}
/**
 * @public
 */
...
type IntrinsicElementAttributesAsMotionValues = SetMotionValueType<SvelteHTMLElements, keyof SVGAttributesWithMotionValues>;
