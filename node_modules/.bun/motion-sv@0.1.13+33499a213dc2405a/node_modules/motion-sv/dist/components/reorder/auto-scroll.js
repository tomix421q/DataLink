...
// Track initial scroll limits per scrollable element (prevents infinite scroll)
...
export function autoScrollIfNeeded(groupElement, pointerPosition, axis, velocity) {
    if (!groupElement)
        return;
