...
/** Convert for MustacheTag */
export declare function convertRawMustacheTag(node: SvAST.RawMustacheTag | Compiler.HtmlTag, parent: SvelteMustacheTagRaw["parent"], ctx: Context): SvelteMustacheTagRaw;
