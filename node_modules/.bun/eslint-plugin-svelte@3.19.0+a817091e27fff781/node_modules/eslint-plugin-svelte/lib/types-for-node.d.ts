...
export type ASTNodeListener = {
    ...
    'JSXExpressionContainer:exit'?: (node: TSESTree.JSXExpressionContainer & ASTNodeWithParent) => void;
    ...
    'SvelteMemberExpressionName:exit'?: (node: AST.SvelteMemberExpressionName & ASTNodeWithParent) => void;
    ...
    'SvelteSpecialDirectiveKey:exit'?: (node: AST.SvelteSpecialDirectiveKey & ASTNodeWithParent) => void;
    ...
    SvelteFunctionBindingsExpression?: (node: AST.SvelteFunctionBindingsExpression & ASTNodeWithParent) => void;
    'SvelteFunctionBindingsExpression:exit'?: (node: AST.SvelteFunctionBindingsExpression & ASTNodeWithParent) => void;
};
