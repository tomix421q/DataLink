<script lang="ts">
	...
	let tab = $state<'existbm' | 'createnewbm'>('existbm');
...
<Dialog.Root bind:open>
	...
	<Dialog.Content class="flex flex-col h-[425px] cardNormalize">
		...
		<div class="mb-12">
			<section class="grid grid-cols-2 gap-2 p-1 bg-secondary rounded-lg my-4">
				<Button
				...
				<Button
					...
					class="rounded-xl!"
				>
					<BookmarkPlusIcon /><span>Create new folder</span>
				</Button>
			</section>
